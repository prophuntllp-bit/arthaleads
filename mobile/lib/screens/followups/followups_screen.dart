...
class _FollowUpsScreenState extends State<FollowUpsScreen> {
  ...
  Future<void> _load({bool reset = false}) async {
    ...
    try {
      final res = await _api.dio.get('/followups', queryParameters: {
        'section': _section,
        'page': _page,
        'limit': 50,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(ApiClient.errorMessage(e, 'Failed to load follow-ups')),
  ...
  Future<void> _reschedule(Map<String, dynamic> lead) async {
    ...
    try {
      if (isProject) {
        ...
        await _api.dio.patch('/leads/${lead['_id']}',
      ...
      children: [
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text('$_total follow-ups', style: Theme.of(context).textTheme.bodySmall),
          ),
        ),
        Expanded(
