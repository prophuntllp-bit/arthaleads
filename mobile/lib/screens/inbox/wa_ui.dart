...
export '../../widgets/app_select.dart' show AppSelect;
...
/// Inbox's original bottom-sheet picker, now the shared [AppSelect] every
/// screen uses — kept as a type alias so existing `WaSelect<T>(...)` call
/// sites in this directory don't need to change.
typedef WaSelect<T> = AppSelect<T>;
