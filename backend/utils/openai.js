...
Marking a lead's Lead Outcome (the field that used to be called "Booking") as "Not Interested" does NOT move it to Dump any more. It stays in the Leads list with that outcome, where the agent left it. If someone remembers Not Interested leads disappearing, that was the old behaviour and it has been removed — the leads it had moved are back in the main list.
...
CTWA button flow (Growth plan and above): replaces the first few free-text questions with real WhatsApp buttons/lists for people who arrive from a Click-to-WhatsApp ad. Flow: optional welcome message ({{name}}, {{project}}) -> up to 5 qualifying questions (each with up to 10 options; each can map to a lead field: purpose, budget, timeline, configuration, property type, city, preferred location, street address, or just be recorded) -> a "what next?" menu of up to 3 buttons (Photos & Videos, Floor Plan & Brochure, location, book site visit, talk to advisor; photos, video, floor plan and brochure are uploaded on the Projects page: videos up to 10MB, larger ones up to 20MB are compressed automatically, PDFs up to 10MB, up to 15MB compressed) -> site-visit time slots (up to 3) -> closing prompt, always followed by fixed "Talk to Advisor" / "Book Site Visit" buttons. Answers write straight onto the lead. Booking a site visit sets the lead to Site Visit and pauses the bot; Talk to Advisor assigns a human and notifies them. Test phone numbers (up to 25) restrict the flow to your own team while you verify it. If someone types instead of tapping, the normal AI conversation takes over. Questions the lead form already answered (budget, timeline, configuration, location) are skipped. Optional "Follow up if they go quiet": one reminder after about 15 minutes and a last one before the 24-hour reply window closes, business hours only, never more than two. Asking for a floor plan, video or a visit pings the team right away as a hot lead. Each flow agent shows a drop-off funnel (how many reached each step and how the flow ended) on its edit page. A live preview lets you tap through the flow.
