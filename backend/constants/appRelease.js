...
module.exports = {
  android: {
    ...
    // local/untracked).
    url: "https://github.com/prophuntllp-bit/arthaleads/releases/download/mobile-v1.0.1-8/arthaleads-1.0.1%2B8-arm64.apk",
    // Optional short "what's new" line.
    notes: "Leads list quick-call now also offers EnableX or phone dialer.",
  },
};
