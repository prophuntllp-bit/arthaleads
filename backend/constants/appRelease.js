...
module.exports = {
  android: {
    ...
    // local/untracked).
    url: "https://github.com/prophuntllp-bit/arthaleads/releases/download/mobile-v1.0.1-9/arthaleads-1.0.1%2B9-arm64.apk",
    // Optional short "what's new" line.
    notes: "Form labels fixed, photos/profile pic now render, AI avatar is draggable.",
  },
};
