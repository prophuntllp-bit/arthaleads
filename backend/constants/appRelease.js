...
module.exports = {
  android: {
    ...
    // local/untracked).
    url: "https://github.com/prophuntllp-bit/arthaleads/releases/download/mobile-v1.0.1-13/arthaleads-1.0.1%2B13-arm64.apk",
    // Optional short "what's new" line.
    notes: "Fixed Google Sign-In on the app.",
  },
};
